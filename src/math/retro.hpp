...
//
// This header defines retro angle math derived from the classic sonic games.
#pragma once
#include <primitive>

namespace math {
    template <typename T> struct [[deprecated]] [[clang::trivial_abi]] point final { // NOLINT(readability-identifier-naming)
        T x, y;
